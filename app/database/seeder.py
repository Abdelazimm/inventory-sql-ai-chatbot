...
logger = logging.getLogger("inventory_seeder")
...
def seed_database_if_empty():
    ...
    try:
        ...
        logger.info("Auto-seeding empty database with demo inventory data...")
        ...
        # 4. Sites
        sites = [
            Site(SiteCode="HQ", SiteName="HQ", AddressLine1="100 HQ Drive", City="New York", Country="USA", TimeZone="EST"),
